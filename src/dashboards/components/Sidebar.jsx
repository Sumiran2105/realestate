...
const DesktopSidebar = ({ currentMenu, handleLinkClick, handleLogout, isLinkActive, role, user }) => (
...
const MobileSidebar = ({ currentMenu, handleLinkClick, handleLogout, isLinkActive, isOpen, onClose }) => (
...
const Sidebar = ({ role, isOpen, onClose }) => {
  ...
  const menuItems = {
    ...
    builder: [
      { path: "/dashboard/builder", icon: <FaChartBar />, label: "Dashboard", exact: true },
      { path: "/dashboard/builder/properties", icon: <FaHome />, label: "My Properties" },
      { path: "/dashboard/builder/add-property", icon: <FaPlus />, label: "List Property" },
      { path: "/dashboard/builder/inquiries", icon: <FaComments />, label: "Inquiries" },
      { path: "/dashboard/builder/profile", icon: <FaUser />, label: "Profile" },
    ],
    admin: [
