  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="mb-8">
          <h2 className="text-2xl sm:text-3xl text-center font-bold text-blue-900">What We Verify</h2>
          <p className="text-slate-600 mt-2 text-center">Core checks designed to reduce fraud and documentation gaps.</p>
        </div>
      ...
      <section className="bg-white border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-blue-900 text-center">Verification Process</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-blue-900">Verification Plans</h2>
        </div>
