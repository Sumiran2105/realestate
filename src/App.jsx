...
// KYC Pages
import BasicKYC from './pages/kyc/BasicKYC';
import IdentityVerification from './pages/kyc/IdentityVerification';
import ProfessionalVerification from './pages/kyc/ProfessionalVerification';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className={`flex-grow ${!showNavFooter ? 'pt-0' : ''}`}>
        ...
        <Routes>
          ...
          {/* KYC Routes - Protected, require authentication */}
          <Route path="/kyc/basic" element={
            <ProtectedRoute>
              <BasicKYC />
            </ProtectedRoute>
          } />
          ...
          <Route path="/kyc/professional" element={
            <ProtectedRoute>
